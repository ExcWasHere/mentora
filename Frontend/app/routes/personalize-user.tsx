...
import PersonalizeUser from "../components/profile/personalize-user";
...
export async function action({ request }: ActionFunctionArgs) {
  ...
  try {
    const res = await fetch("https://mentora-977901323224.asia-southeast2.run.app/api/user-profile", { // ✅ endpoint fix
      method: "POST",
      headers: {
